...
Citizen.CreateThread(function()
	while true do
		...
		function zamknijdrzwi()
		    for k,v in pairs(Banks) do
					local kordy = v.position
					local drzwi = v.doortype
					print(drzwi)
		        local door = GetClosestObjectOfType(kordy.x, kordy.y, kordy.z, 3.0, drzwi)
						print(door)
		        SetEntityRotation(door, 0.0, 0.0, 249.846, 0.0)
